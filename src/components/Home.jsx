  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
      ...
      <div className ='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
          ...
          <p className="text-[#8892b0] py-4 max-w-[700px]">Web developer with a focus on the front-end, utilizing JavaScript ES6, communications, and various team building methodologies. Prior background includes 7+ years of education, continuously seeking ways to simplify ideas and instruction. Seeking an exciting opportunity to utilize my combined experience while bringing fresh ideas to fruition. </p>
          <div>
            <button className="text-white border-2 px-6 py-3 my-2 flex items-center hover:bg-blue-600 hover:border-white">View Work
